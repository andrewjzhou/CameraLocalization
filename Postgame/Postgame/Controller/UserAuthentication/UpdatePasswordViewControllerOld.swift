...
//
//class UpdatePasswordViewControllerOld: UIViewController {
//    
//    // UI
...
//        confirmationCodeLabel.leftAnchor.constraint(equalTo: view.leftAnchor, constant: view.bounds.width * 0.05).isActive = trueresend
